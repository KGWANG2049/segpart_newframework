...
def train(local_rank, config):  # the first arg must be local rank for the sake of using mp.spawn(...)
    ...
    # get model
    my_model = shapenet_model.ShapeNetModelSeg(config['Point_Embedding']['point_emb1_in'],
                                               config['Point_Embedding']['point_emb1_out'],
                                               config['Point_Embedding']['point_emb2_in'],
                                               config['Point_Embedding']['point_emb2_out'],
                                               config['Downsample']['points_select_basis'],
                                               config['Downsample']['n_samples'],
                                               config['Downsample']['embedding_k'],
                                               config['Downsample']['conv1_channel_in'],
